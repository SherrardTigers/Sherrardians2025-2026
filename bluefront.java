...
@Autonomous(name="start_blue_front", group="Auto")
public class bluefront extends LinearOpMode {
    ...
    private static final double NOMINAL_VOLTAGE = 13.0; // Target voltage for consistent launcher speed
    private static final double BASE_LAUNCHER_POWER = 0.50; // Base power at nominal voltage
