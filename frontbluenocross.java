...
@Autonomous(name="Blue Launch test", group="Auto")
public class frontbluenocross extends LinearOpMode {
    ...
    private static final double BASE_LAUNCHER_POWER = 0.601; // Base power at nominal voltage
