...
@Autonomous(name="Blue Launch", group="Auto")
public class frontbluelaunch extends LinearOpMode {
    ...
    private static final double BASE_LAUNCHER_POWER = 0.585; // Base power at nominal voltage
