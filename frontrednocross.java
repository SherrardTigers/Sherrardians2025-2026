...
@Autonomous(name="red Launch test", group="Auto")
public class frontrednocross extends LinearOpMode {
    ...
    private static final double BASE_LAUNCHER_POWER = 0.595; // Base power at nominal voltage
